...
bool Intersection::isThereEmergencyStreet(){
...
bool Intersection::isThereHighCongestionStreet(){
    for (auto &street : streets){
...
bool Intersection::isTherePedestrianStreet(){
    for (auto &street : streets){
...
const std::vector<Street> Intersection::getStreets() const
{
 ...
 std::vector<Car> Intersection::sortAllIntersectionCarsByDistance(){
    std::vector<Car> cars;
    for (auto &street : streets) {
